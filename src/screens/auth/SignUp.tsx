  ...
  return (
    <SafeAreaView className="flex-1 bg-neutral px-lg">
      ...
      <View className="mt-sm mb-xl">
        ...
        >
          <Feather name="chevron-left" size={40} className="text-primary" />
        </Pressable>
      </View>
      ...
      <View className="flex-1 justify-center pb-xl">
        ...
        <View className="items-center mb-xl">
          <View className="w-24 h-24 bg- rounded-full items-center justify-center mb-sm">
            <Feather name="cloud-drizzle" size={40} className='color-surface' />
          </View>
        </View>
        ...
        <View className="gap-md w-full mt-lg">
          ...
          >
            <AntDesign
              name="google"
              size={24}
              className="text-on-tertiary absolute left-6"
            />
